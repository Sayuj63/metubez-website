        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 md:gap-8">
          <div className="col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              />
              <span className="text-[20px] font-black text-[#57a554]">
                MeTubez
              </span>
            </div>
      ...
      <ul className="flex flex-col gap-2.5">
        {items.map((item) => (
          <li key={item.label}>
            <Link
              href={item.href}
              className="text-[13px] text-[#666] hover:text-[#57a554] transition-colors"
            >
              {item.label}
            </Link>
          </li>
...
function Social({
  ...
  return (
    <a
      href="#"
      aria-label={label}
      className="w-9 h-9 rounded-md border border-[#ddd] flex items-center justify-center text-[#666] hover:bg-[#57a554] hover:text-white hover:border-[#57a554] transition-colors"
    >
